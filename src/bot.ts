...
export const site = require('./website.js')
export const Utilities = require('./Utilities.js')
export const BLOB = require('./blob.js')
export const uniqid = require('uniqid');

export const command = require('./command.js')
export const slashcommand = require('./slashhandler.js')
let toggle = 0;

export const ytdl = require('ytdl-core');

export const callfunc = require('./callfunc.js');
...
exports.setDispatchSlash = async (interaction, member) => {
    try {
        ...
        let songEmbedYTDL = new Discord.MessageEmbed()
